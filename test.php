...
$console->warning('Warning: The connection to the remote server is unstable! Several attempts to establish a stable connection have failed, and data integrity cannot be guaranteed. Please check the network connection and try again later.');
...
for ($i = 0; $i <= 100; $i++) {
    ...
    usleep(5000); // Simulate some work being done
}
...
$password = $console->ask('Enter your demo password', true);
